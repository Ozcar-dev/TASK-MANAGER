          ...
          <NavBar/>
            ...
            <section className="flex flex-col-reverse md:flex-row items-center justify-between w-full pt-18 md:pt-16 lg:pt-20 gap-0 md:gap-0">
              ...
              <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto">
                <button onClick={() => navigate('/my-tasks')} className="bg-purple-600 hover:bg-purple-900 text-white px-8 py-3 rounded-lg font-semibold transition duration-500 w-full sm:w-auto">
                  Go to My Tasks
                </button>
                <button onClick={() => navigate('/new-task')} className="bg-purple-600 hover:bg-purple-900 text-white px-8 py-3 rounded-lg font-semibold transition duration-500 w-full sm:w-auto">
                  + Add a task
                </button>
            </div>
        </div>
